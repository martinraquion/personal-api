  $( document ).ready(function() {
      ...
      let musixUrl = `${allowCORS}https://api.musixmatch.com/ws/1.1/chart.tracks.get?chart_name=top&page=1&page_size=10&country=us&f_has_lyrics=1@&apikey=${apikey}`
          ...
          .then(function(chart){
              ...
              $('#song-search').click(function(){
                ...
                $('#searchInp').on('keyup', function(){
                  ...
                  // console.log(indexOf(word))
                  // console.log(word)
                  $(".rank-container").filter(function() {
